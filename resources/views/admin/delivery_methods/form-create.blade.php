...
<form action="{{ route('delivery-methods.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="mb-4">
        <label for="nama" class="block text-gray-700 dark:text-gray-200">delivery Method Name</label>
    ...
    <div class="mb-4">
        <label for="shipping_cost" class="block text-gray-700 dark:text-gray-200">Shipping Cost</label>
