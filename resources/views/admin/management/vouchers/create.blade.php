        ...
        <form action="{{ route('admin.management.vouchers.store') }}" method="POST"
            ...
            <div class="space-y-4 border-t pt-4">
                ...
                <div class="space-y-1.5" id="valueField">
                    <label for="value" class="block text-xs font-medium text-gray-600">
                        <span id="valueLabel">Nilai Diskon</span>
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="min_purchase" id="min_purchase" value="{{ old('min_purchase', 0) }}" 
                            placeholder="0" min="0"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="space-y-1.5">
                        <label for="expired_at" class="block text-xs font-medium text-gray-600">
                            Kadaluarsa Pada <span class="text-red-500">*</span>
                        </label>
                        <input type="datetime-local" name="expired_at" id="expired_at" value="{{ old('expired_at') }}" required
                            class="w-full rounded-xl border border-gray-200 px-3 py-2.5 text-sm text-gray-700
            ...
            <div class="space-y-4 border-t pt-4">
                ...
                <div class="space-y-3">
                    ...
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="allow_multiple_use" value="1" {{ old('allow_multiple_use') ? 'checked' : '' }}
                            class="h-4 w-4 rounded border-gray-300">
                        <span class="text-sm text-gray-600">Izinkan penggunaan berulang per pelanggan</span>
                    </label>

                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="apply_to_all" value="1" {{ old('apply_to_all', true) ? 'checked' : '' }}
                            class="h-4 w-4 rounded border-gray-300">
            ...
            <div class="px-4 py-3 bg-blue-50 rounded-xl border border-blue-100">
                ...
                <ul class="text-xs text-blue-700 mt-1 space-y-0.5">
                    ...
                    <li>• Tentukan tanggal kadaluarsa untuk membatasi periode berlaku</li>
                    <li>• Diskon Persen (%) dan Tetap (Fixed) bersaing dengan Product Discount</li>
                </ul>
            </div>
