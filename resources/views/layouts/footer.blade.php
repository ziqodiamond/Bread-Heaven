            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
                <div>
                    ...
                    <ul class="mt-6 space-y-4 text-sm">
                        <li>
                            <a href="/" class="text-gray-700 transition hover:opacity-75 dark:text-gray-200"> Home
                            </a>
                        </li>

                        <li>
                            <a href="/posts" class="text-gray-700 transition hover:opacity-75 dark:text-gray-200">
                                Posts </a>
                        </li>

                        <li>
                            <a href="#product" class="text-gray-700 transition hover:opacity-75 dark:text-gray-200">
                                Products </a>
                        </li>
                ...
                <div>
                    ...
                    <ul class="mt-6 space-y-4 text-sm">
                        ...
                        <li>
                            <a href="#" class="text-gray-700 transition hover:opacity-75 dark:text-gray-200"> FAQs
                            </a>
                        </li>
