{{-- resources/views/admin/management/categories/create.blade.php --}}
<x-layout-admin>
    <div class="space-y-5">

        {{-- ── Header ─────────────────────────────────────────────────── --}}
        <div>
            <h2 class="text-base font-medium text-gray-900">Tambah Kategori</h2>
            <p class="text-sm text-gray-400 mt-0.5">Buat kategori produk baru</p>
        </div>

        {{-- ── Form ───────────────────────────────────────────────────── --}}
        <div class="rounded-xl border border-gray-100 bg-white p-6">

            <form action="{{ route('admin.management.categories.store') }}" method="POST" class="space-y-5">
